...
lecturesDetails.set(
  ...
  `<h1>Packaging development to stop food waste</h1><h4>Difficulty level</h4><p>Intermediate<i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star-o star-color-yellow little-space"></i></p><h4>Topics</h4><p>ppwr2,ppwr</p><h4>Abstract</h4><p>Well-designed packaging, crucial for a welfare state, support for food preservation and transport
...
producers should educate consumers to reduce this unnecessary waste.</p><a target="_blank" class="btn btn-primary" href="" id="lecture-button-Food-Waste-Prevention" style="background-color: rgb(236, 104, 7); border-color: rgb(236, 104, 7); margin-bottom: 2%;">Read the lecture</a><h4>Authors</h4><ul><li>Helén Williams</li></ul>`
);
lecturesDetails.set(
...
lecturesDetails.set(
  "PPWR2/RECYCLING PKG DAY/EU-vs-US-Agencies",
  `<h1>Public Regulatory Agencies in the EU and the US</h1><h4>Difficulty level</h4><p>Intermediate<i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star-o star-color-yellow little-space"></i></p><h4>Topics</h4><p>ppwr2,ppwr</p><h4>Abstract</h4><p>Abstract</p><a target="_blank" class="btn btn-primary" href="" id="lecture-button-EU-vs-US-Agencies" style="background-color: rgb(236, 104, 7); border-color: rgb(236, 104, 7); margin-bottom: 2%;">Read the lecture</a><h4>Authors</h4><ul><li>Olivier VITRAC</li></ul>`
);
lecturesDetails.set(
  "PPWR2/RECYCLING PKG DAY/EU-PKG-Approval-History",
  `<h1>History and evolution of food contact packaging approval in EU</h1><h4>Difficulty level</h4><p>Intermediate<i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star-o star-color-yellow little-space"></i></p><h4>Topics</h4><p>ppwr2,ppwr</p><h4>Abstract</h4><p>The EU FCM legislation was born in the 70s with general safety principles, still valid. Harmonized measures
...
auditable GMP systems was established in more recent EU legislation.</p><a target="_blank" class="btn btn-primary" href="" id="lecture-button-EU-PKG-Approval-History" style="background-color: rgb(236, 104, 7); border-color: rgb(236, 104, 7); margin-bottom: 2%;">Read the lecture</a><h4>Authors</h4><ul><li>Maria Rosaria MILANA</li></ul>`
);
lecturesDetails.set(
  "PPWR2/RECYCLING PKG DAY/FDA-on-Recycled-Plastics",
  `<h1>Recycled Plastics in Food Packaging</h1><h4>Difficulty level</h4><p>Intermediate<i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star-o star-color-yellow little-space"></i></p><h4>Topics</h4><p>topic1,topic2,topic3</p><h4>Abstract</h4><p>There is an emphasis throughout the United States on increasing the use of post-consumer
...
use, and some of the challenges we face.</p><a target="_blank" class="btn btn-primary" href="" id="lecture-button-FDA-on-Recycled-Plastics" style="background-color: rgb(236, 104, 7); border-color: rgb(236, 104, 7); margin-bottom: 2%;">Read the lecture</a><h4>Authors</h4><ul><li>Sean Fischer</li></ul>`
);
lecturesDetails.set(
...
lecturesDetails.set(
  ...
  `<h1>Safety issues for recycled PET and beyond:</h1><h4>Difficulty level</h4><p>Intermediate<i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star-o star-color-yellow little-space"></i></p><h4>Topics</h4><p>ppwr2,ppwr</p><h4>Abstract</h4><p>The rapid adoption of recycled materials-from plastics to cellulosic substances-has out-
...
the journey from waste to future packaging.</p><a target="_blank" class="btn btn-primary" href="" id="lecture-button-Recycled-PET-Safety" style="background-color: rgb(236, 104, 7); border-color: rgb(236, 104, 7); margin-bottom: 2%;">Read the lecture</a><h4>Authors</h4><ul><li>Olivier VITRAC</li></ul>`
);
lecturesDetails.set(
  "PPWR2/RECYCLING PKG DAY/Recycled-PKG-in-Food",
  `<h1>The contamination of food by recycled paper and board packaging starts at the scale of fibers.</h1><h4>Difficulty level</h4><p>Intermediate<i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star-o star-color-yellow little-space"></i></p><h4>Topics</h4><p>ppwr2,ppwr</p><h4>Abstract</h4><p>Food packaging contamination has become a significant concern due to implementing circular
...
materials in a circular economy.</p><a target="_blank" class="btn btn-primary" href="" id="lecture-button-Recycled-PKG-in-Food" style="background-color: rgb(236, 104, 7); border-color: rgb(236, 104, 7); margin-bottom: 2%;">Read the lecture</a><h4>Authors</h4><ul><li>Lucas Biant</li><li>Julien Kermorvant</li><li>Murielle Hayert</li><li>Phuong-Mai Nguyen</li><li>Olivier Vitrac</li></ul>`
);
lecturesDetails.set(
...
lecturesDetails.set(
  ...
  `<h1>Buddie-Pack project: european project on reuse plastic packaging</h1><h4>Difficulty level</h4><p>Intermediate<i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star star-color-yellow little-space"></i><i class="fa fa-star-o star-color-yellow little-space"></i></p><h4>Topics</h4><p>ppwr2,ppwr</p><h4>Abstract</h4><p>The European project BUDDIE-PACK, funded by the new Horizon Europe programme and coordinated by the
...
cycle. Cleaning technologies will be optimised and integrated in a cleaning pilot line.</p><a target="_blank" class="btn btn-primary" href="" id="lecture-button-Buddie-Pack-Project" style="background-color: rgb(236, 104, 7); border-color: rgb(236, 104, 7); margin-bottom: 2%;">Read the lecture</a><h4>Authors</h4><ul><li>Phuong-Mai NGUYEN</li></ul>`
);
lecturesDetails.set(
...
dropDownMenuContent = `    <button class="dropdown-btn" id="dropdown-btn-PPWR2">PPWR2<i class="fa fa-caret-down"></i></button>
    <div class="dropdown-container" id="dropdown-container-PPWR2"><button class="dropdown-btn"
        ...
        <div class="dropdown-container" id="dropdown-container-RECYCLING PKG DAY"><a
                ...
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Packaging development to stop food
                waste<i class="fa fa-star star-color-yellow little-space"></i><i
                ...
                onclick="lectureToDisplay(this.id)">Trends in regulation for food packaging in Chile<i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                ...
                Sustainable Packaging Regulations in North America<i
                    ...
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                href="#PPWR2/RECYCLING PKG DAY/EU-vs-US-Agencies" id="PPWR2/RECYCLING PKG DAY/EU-vs-US-Agencies"
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Public Regulatory Agencies in the
                EU and the US<i class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                ...
                onclick="lectureToDisplay(this.id)">History and evolution of food contact packaging approval in EU<i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                ...
                onclick="lectureToDisplay(this.id)">Recycled Plastics in Food Packaging<i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                href="#PPWR2/RECYCLING PKG DAY/EFSA-on-PET-Recycling" id="PPWR2/RECYCLING PKG DAY/EFSA-on-PET-Recycling"
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">EFSA safety evaluation of
                mechanical recycling processes used to produce
                ...
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">APR and RecyClass - Different
                Geographies, Common Purpose<i class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                ...
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Safety issues for recycled PET and
                beyond:<i class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                href="#PPWR2/RECYCLING PKG DAY/Recycled-PKG-in-Food" id="PPWR2/RECYCLING PKG DAY/Recycled-PKG-in-Food"
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">The contamination of food by
                recycled paper and board packaging starts at the scale of fibers.<i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
        ...
        <div class="dropdown-container" id="dropdown-container-REUSE PKG DAY"><a
                ...
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">How PR3 standards for reusable
                packaging can reduce costs, ensure performance, and lead to scale<i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                href="#PPWR2/REUSE PKG DAY/Industrializing-PKG-Reuse" id="PPWR2/REUSE PKG DAY/Industrializing-PKG-Reuse"
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">How to industrialize packaging
                reuse?<i class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                href="#PPWR2/REUSE PKG DAY/Secondary-PKG-Reuse" id="PPWR2/REUSE PKG DAY/Secondary-PKG-Reuse"
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Ecological and economic assessment
                of reusable packaging in a refrigerated supply chain<i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                href="#PPWR2/REUSE PKG DAY/Buddie-Pack-Project" id="PPWR2/REUSE PKG DAY/Buddie-Pack-Project"
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Buddie-Pack project: european
                project on reuse plastic packaging<i class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                ...
                onclick="lectureToDisplay(this.id)">Development of Virtual and Remote Teaching Laboratories for Food
                Science and Engineering Students<i class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star-o star-color-yellow little-space"></i></a><a
                href="#PPWR2/REUSE PKG DAY/PKG-Education-in-the-US" id="PPWR2/REUSE PKG DAY/PKG-Education-in-the-US"
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Packaging education in the U.S. and
                the SoP @ MSU<i class="fa fa-star star-color-yellow little-space"></i><i
                    class="fa fa-star star-color-yellow little-space"></i><i
    ...
    <div class="dropdown-container" id="dropdown-container-Packaging design"><button class="dropdown-btn"
        ...
        <div class="dropdown-container"
            id="dropdown-container-the-basics-of-mechanical-engineering-for-packaging-designer"></div><a
