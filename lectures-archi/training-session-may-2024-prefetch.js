...
<div class="dropdown-container" id="dropdown-container-Day 1"><button class="dropdown-btn"
    ...
    <div class="dropdown-container" id="dropdown-container-Bio-based-and-biodegradable-materials"><a
            ...
            class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Bio-based and biodegradable materials<i
    ...
    <div class="dropdown-container" id="dropdown-container-Do-we-need-and-how-to-substitute-plastics"><a
            href="#Day 1/Do-we-need-and-how-to-substitute-plastics" id="Day 1/Do-we-need-and-how-to-substitute-plastics"
            class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Do we need and how to substitute
            plastics?<i class="fa fa-star star-color-green little-space"></i><i
                class="fa fa-star-o star-color-green little-space"></i><i
                class="fa fa-star-o star-color-green little-space"></i></a></div><button class="dropdown-btn"
    ...
    <div class="dropdown-container" id="dropdown-container-Environmental-impact-of-packaging"><a
            ...
            class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Environmental impact of packaging<i
                ...
                class="fa fa-star-o star-color-green little-space"></i><i
                class="fa fa-star-o star-color-green little-space"></i></a></div><button class="dropdown-btn"
        id="dropdown-btn-Panorama-of-food-packaging">Panorama-of-food-packaging<i class="fa fa-caret-down"></i></button>
    ...
    <div class="dropdown-container" id="dropdown-container-Safety-assessments-of-biobased-materials"><a
            href="#Day 1/Safety-assessments-of-biobased-materials" id="Day 1/Safety-assessments-of-biobased-materials"
            class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Safety assessments of biobased
...
<div class="dropdown-container" id="dropdown-container-Day 2"><button class="dropdown-btn"
        id="dropdown-btn-Functional-barrier-concept">Functional-barrier-concept<i class="fa fa-caret-down"></i></button>
    <div class="dropdown-container" id="dropdown-container-Functional-barrier-concept"><a
            ...
            class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Functional barrier concept and how to
            design (by modeling tool) including substance transfer for flexible materials in a roll<i
                class="fa fa-star star-color-green little-space"></i><i
                class="fa fa-star-o star-color-green little-space"></i><i
                class="fa fa-star-o star-color-green little-space"></i></a></div><button class="dropdown-btn"
        id="dropdown-btn-Introduction-on-recycling">Introduction-on-recycling<i class="fa fa-caret-down"></i></button>
    <div class="dropdown-container" id="dropdown-container-Introduction-on-recycling"><a
            ...
            class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Introduction on recycling + Plastics -
            safety assessment of plastics recycling processed for food contact materials<i
                class="fa fa-star star-color-green little-space"></i><i
                class="fa fa-star-o star-color-green little-space"></i><i
                class="fa fa-star-o star-color-green little-space"></i></a></div><button class="dropdown-btn"
    ...
    <div class="dropdown-container"
        id="dropdown-container-Use-of-information-theory-for-the-unsupervised-identification-of-contaminants"><a
            ...
            unsupervised identification of contaminants in recycled materials (plastic and cellulose) intended to come
            into contact with food.<i class="fa fa-star star-color-green little-space"></i><i
                class="fa fa-star-o star-color-green little-space"></i><i
                class="fa fa-star-o star-color-green little-space"></i></a></div>
</div>`;
