...
lecturesDetails.set(
  ...
  `<h1>Reusable and returnable systems</h1><h4>Difficulty level</h4><span>Novice<i class="fa fa-star star-color-green little-space"></i><i class="fa fa-star-o star-color-green little-space"></i><i class="fa fa-star-o star-color-green little-space"></i></span><h4>Topics</h4><p>reusable,returnable</p><h4>Abstract</h4><p>Reusable and returnable systems</p><a target="_blank" class="btn btn-primary" href="https://fitness.agroparistech.fr/fitness2/lectures/viewer/index.html#reusable-and-returnable-systems" id="lecture-button-Reusable-and-returnable-systems" style="background-color: rgb(236, 104, 7); border-color: rgb(236, 104, 7); margin-bottom: 2%;">Read the lecture</a><h4 id="q-and-a-header" style="display: none;">Test your knowledge</h4><p id="q-and-a-par" style="display: none;">There is no assessment for this lecture.</p><h4>Authors</h4><ul><li>Ilke Uysal Unalan</li></ul>`
);
lecturesDetails.set(
...
lecturesDetails.set(
  ...
  `<h1>Recycling packaging material processes, safety and comparison of recycled materials with native ones</h1><h4>Difficulty level</h4><span>Novice<i class="fa fa-star star-color-green little-space"></i><i class="fa fa-star-o star-color-green little-space"></i><i class="fa fa-star-o star-color-green little-space"></i></span><h4>Topics</h4><p>Recycling Processes,Regulatory Framework,Quantification of Contaminants</p><h4>Abstract</h4><p>Recycling packaging materials is crucial for achieving sustainability and protecting the environment. This lecture delves into the intricate recycling processes, focusing on safety considerations and a detailed comparison of recycled materials versus their native counterparts. We will examine the current regulatory landscape, highlighting its limitations and existing testing procedures, and underscore the necessity for stricter compliance to ensure food safety. Special attention will be given to the new Packaging and Packaging Waste Regulation (PPWR) voted on April 24, 2024, in the EU, discussing its legal implications and the additional requirements it imposes on recycling processes. Key topics include identifying and quantifying contaminants, the hazards associated with virgin and recycled plastics, and emerging risks from non-intentionally added substances (uncontrolled sourcing, poor sorting, misuse). The lecture will provide an in-depth look at various mechanical, chemical, and enzymatic recycling methods, exploring their respective advantages and limitations. Additionally, we will emphasize the significance of designing for recycling and implementing ecodesign principles to reduce environmental impact while ensuring safety. The session will conclude with comprehensive recommendations for future research and development, advocating for inclusive engineering approaches that address all facets of packaging, environmental sustainability, industrial practices, health considerations, and the new legal landscape.</p><a target="_blank" class="btn btn-primary" href="https://fitness.agroparistech.fr/fitness2/lectures/viewer/index.html#recycling-safety" id="lecture-button-Recycling-packaging-material-processes-safety" style="background-color: rgb(236, 104, 7); border-color: rgb(236, 104, 7); margin-bottom: 2%;">Read the lecture</a><h4 id="q-and-a-header" style="display: none;">Test your knowledge</h4><p id="q-and-a-par" style="display: none;">There is no assessment for this lecture.</p><h4>Authors</h4><ul><li>Phuong-Mai Nguyen</li><li>Olivier Vitrac</li></ul>`
);
lecturesDetails.set(
...
dropDownMenuContent = `    <button class="dropdown-btn" id="dropdown-btn-Day 1">Day 1<i class="fa fa-caret-down"></i></button>
    <div class="dropdown-container" id="dropdown-container-Day 1"><button class="dropdown-btn"
        ...
        <div class="dropdown-container" id="dropdown-container-Bio-based-and-biodegradable-materials"><a
                ...
                materials<i class="fa fa-star star-color-yellow little-space"></i><i
        ...
        <div class="dropdown-container" id="dropdown-container-Recycling-of-paper-and-board"><a
                ...
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Recycling of paper and board<i
                    ...
                    class="fa fa-star-o star-color-green little-space"></i><i
                    class="fa fa-star-o star-color-green little-space"></i></a></div><button class="dropdown-btn"
            id="dropdown-btn-Reusable-and-returnable-systems">Reusable-and-returnable-systems<i
                class="fa fa-caret-down"></i></button>
        <div class="dropdown-container" id="dropdown-container-Reusable-and-returnable-systems"><a
                href="#Day 1/Reusable-and-returnable-systems" id="Day 1/Reusable-and-returnable-systems"
                class="dropdown-container-class" onclick="lectureToDisplay(this.id)">Reusable and returnable systems<i
                    class="fa fa-star star-color-green little-space"></i><i
                    class="fa fa-star-o star-color-green little-space"></i><i
                    class="fa fa-star-o star-color-green little-space"></i></a></div><button class="dropdown-btn"
