...
function handleEvent() {
  ...
  console.log("sidepanel begin");

  console.log(plasticPackChildren);
  console.log(smartChildren);
...
function loadRootJS() {
  for (let i = 0; i < rootChildren.length; i++) {
    let currentJSFile = "manifests/" + rootChildren[i] + ".js";
...
window.addEventListener("load", function () {
  // your code here
  console.log(
    "the whole document including dynamic scripts has been loaded begin"
  );
  ...
  console.log(
    "the whole document including dynamic scripts has been loaded end"
  );
});
...
function getVarNames() {
  ...
  console.log("displaying var beg");
  console.log(variables);
  console.log("displaying var end");
}
getVarNames();
