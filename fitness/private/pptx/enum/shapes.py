...
from fitness.private.pptx.enum.base import (
    alias,
    Enumeration,
    EnumMember,
...
class MSO_AUTO_SHAPE_TYPE(XmlEnumeration):
    ...
    Example::
        ...
        from fitness.private.pptx.enum.shapes import MSO_SHAPE
        from fitness.private.pptx.util import Inches
...
class MSO_CONNECTOR_TYPE(XmlEnumeration):
    ...
    Example::
        ...
        from fitness.private.pptx.enum.shapes import MSO_CONNECTOR
        from fitness.private.pptx.util import Cm
...
class PP_MEDIA_TYPE(Enumeration):
    ...
    Example::
        ...
        from fitness.private.pptx.enum.shapes import PP_MEDIA_TYPE
...
class PP_PLACEHOLDER_TYPE(XmlEnumeration):
    ...
    Example::
        ...
        from fitness.private.pptx.enum.shapes import PP_PLACEHOLDER
...
class _ProgIdEnum(object):
    ...
    Example::
        ...
        from fitness.private.pptx.enum.shapes import PROG_ID
        from fitness.private.pptx.util import Inches
