...
class MSO_COLOR_TYPE(Enumeration):
    ...
    Example::
        ...
        from fitness.private.pptx.enum.dml import MSO_COLOR_TYPE
...
class MSO_LINE_DASH_STYLE(XmlEnumeration):
    ...
    Example::
        ...
        from fitness.private.pptx.enum.dml import MSO_LINE
...
class MSO_PATTERN_TYPE(XmlEnumeration):
    ...
    Example::
        ...
        from fitness.private.pptx.enum.dml import MSO_PATTERN
...
class MSO_THEME_COLOR_INDEX(XmlEnumeration):
    ...
    Example::
        ...
        from fitness.private.pptx.enum.dml import MSO_THEME_COLOR
