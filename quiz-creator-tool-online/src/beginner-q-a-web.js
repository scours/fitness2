/*
 * File: beginner-q-a-web.js
 * Contract: EU contract 2022-FR01-KA220-HED-000023509
 * Project: FitNESS 2 ERASMUS+
 * File Created: Thursday, 12th October 2023
...
function getScoreForCheckboxesQuiz(
  ...
  if (modifyUserAnswersColor) {
    if (rep === true) {
      ...
      // do not color answer, as this is not what we want with this version
...
function showNumberOfAnswersOutOfTotal() {
  // do not show number of correct answers, as this is not what we want with this version
...
document.onreadystatechange = async function () {
  if (document.readyState === "complete") {
    ...
    if (button) {
      ...
      button.textContent = "Click To Finish";
    }
  }
};
